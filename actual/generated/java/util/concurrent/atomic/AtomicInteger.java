...
public class AtomicInteger extends Number implements LibSLRuntime.Automaton, Serializable {
    ...
    public final int accumulateAndGet(int x, IntBinaryOperator accumulatorFunction) {
        ...
        /* body */ {
            final int newValue = accumulatorFunction.applyAsInt(this.value, x);
            result = newValue;
            this.value = newValue;
        }
        return result;
    ...
    public final int addAndGet(int delta) {
        ...
        Engine.assume(this.__$lsl_state == __$lsl_States.Initialized);
        /* body */ {
            final int newValue = this.value + delta;
            result = newValue;
            this.value = newValue;
        }
        return result;
    ...
    public final int compareAndExchange(int expectedValue, int newValue) {
        ...
        Engine.assume(this.__$lsl_state == __$lsl_States.Initialized);
        /* body */ {
            final int currentValue = this.value;
    ...
    public final int decrementAndGet() {
        ...
        Engine.assume(this.__$lsl_state == __$lsl_States.Initialized);
        /* body */ {
            final int newValue = this.value - 1;
            result = newValue;
            this.value = newValue;
        }
        return result;
    ...
    public final int updateAndGet(IntUnaryOperator updateFunction) {
        ...
        Engine.assume(this.__$lsl_state == __$lsl_States.Initialized);
        /* body */ {
            final int newValue = updateFunction.applyAsInt(this.value);
            result = newValue;
            this.value = newValue;
        }
        return result;
