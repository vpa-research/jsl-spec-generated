...
// sources:
//  - java/util/ArrayList.lsl:65
//  - java/util/ArrayList.SubList.Spliterator.lsl:16
//
...
public final class ArrayList_SubList$Spliterator implements LibSLRuntime.Automaton, Spliterator {
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:60
     */
    private int _getFence() {
        ...
        /* body */ {
            if (this.fence == -1) {
                ...
                this.expectedModCount = ((ArrayList_SubList) ((Object) this.parent)).modCount;
                this.fence = ((ArrayList_SubList) ((Object) this.parent)).length;
            }
            result = this.fence;
        }
        return result;
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:80
     */
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:86
     */
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:92
     */
    public void forEachRemaining(Consumer _action) {
        /* body */ {
            ...
            Engine.assume(this.parent != null);
            final SymbolicList<Object> a = ((ArrayList) ((Object) this.root)).storage;
            if (a == null) {
            ...
            if (hi == -1) {
                hi = ((ArrayList_SubList) ((Object) this.parent)).length;
                mc = ((ArrayList_SubList) ((Object) this.parent)).modCount;
            }
            int i = this.index;
            this.index = hi;
            if ((i < 0) || (hi > ((ArrayList_SubList) ((Object) this.parent)).length)) {
                throw new ConcurrentModificationException();
            }
            for (i = i; i < hi; i += 1) {
            ...
            ;
            if (mc != ((ArrayList_SubList) ((Object) this.parent)).modCount) {
                throw new ConcurrentModificationException();
            }
        }
    }
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:141
     */
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:154
     */
    public boolean tryAdvance(Consumer _action) {
        ...
        /* body */ {
            ...
            if (i < hi) {
                ...
                _action.accept(item);
                if (((ArrayList) ((Object) this.root)).modCount != this.expectedModCount) {
                    throw new ConcurrentModificationException();
                }
                result = true;
            } else {
     ...
     * Source: java/util/ArrayList.SubList.Spliterator.lsl:184
     */
