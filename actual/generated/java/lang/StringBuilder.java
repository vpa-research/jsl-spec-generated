...
public final class StringBuilder implements LibSLRuntime.Automaton, Serializable, Comparable<StringBuilder>, CharSequence {
    ...
    private char _lowSurrogate(int codePoint) {
        char result = '?';
        /* body */ {
            result = ((char) ((codePoint & 1023) + MIN_LOW_SURROGATE));
        }
        return result;
    }
    ...
    private char _highSurrogate(int codePoint) {
        char result = '?';
        /* body */ {
            result = ((char) ((codePoint >>> 10) + (MIN_HIGH_SURROGATE - (MIN_SUPPLEMENTARY_CODE_POINT >>> 10))));
        }
        return result;
    }
    ...
    public int codePointAt(int index) {
        ...
        /* body */ {
            _checkIndex(index);
            final int codePoint = Engine.makeSymbolicInt();
            Engine.assume(codePoint >= MIN_CODE_POINT);
            Engine.assume(codePoint <= MAX_CODE_POINT);
            result = codePoint;
        }
        return result;
    }
